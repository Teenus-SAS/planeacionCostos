...
import { IndividualReporteProductoProcesoDataTable } from "../../../application/individual_reporte_producto_proceso_datatable/IndividualReporteProductoProcesoDataTable.js";

export function OnClickGenerateReporteProductoProcesoButton(buttonData) {
  GetReporteProductoProcesosByProductoId(buttonData.productoId, (data) => {
