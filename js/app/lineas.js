...
function toggleCreateOrSelect() {
  if (!flagSelectLineas) {
    ...
    $("#select-lineas").fadeOut(400, function () {
      ...
      $("#btn_create_or_select_lineas").html(
...
$(".add").click(function () {
  ...
  if (n > 0) {
    if ($("#select-lineas").val() != null || !flagSelectLineas) {
      ...
      $.alert("Selecciona una linea", "Tezlik");
    }
  } else {
    $.alert("Selecciona al menos un elemento para agregar", "Tezlik");
  }
});
