...
import { consolidated, productsReq, products, limInf } from "../reporte.js";
    ...
    if (opciones && opciones.tipoDistribucion == 0) {
      productsReq.forEach((productReq, indexProduct) => {
        $.ajax({
          ...
          success: function (data) {
            ...
            if (indexProduct == 0) {
              doc.text(
                "Detalle de Costeo por Producto e indicadores",
                300,
                80,
                {
                  align: "center",
              ...
              success: function (data) {
                ...
                if (data.processes != undefined) {
                  data.processes.forEach((process) => {
                    ...
                    colorsProcess.push(
                      colors[
                        Math.floor(Math.random() * (colors.length - 0)) + 0
                      ]
                    );
                  });
                }
                ...
                chartLaborCost.data.datasets[0].backgroundColor =
                  colorsLaborCost;
                ...
                chartMaterialCost.options.plugins.datalabels.formatter =
            ...
            if (count >= productsReq.length) {
              $.ajax({
                ...
                success: function (data) {
                  let logo =
                    data.company.logo || "../upload/img/logo-empresa.png";
      ...
      productsReq.forEach((productReq, indexProduct) => {
        $.ajax({
          async: false,
          type: "get",
          url: "api/cost_product_by_volumen_ventas.php",
          data: {
            id: productReq.id,
            quantity: productReq.quantity,
          },
